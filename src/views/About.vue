        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-card class="box-card">
              ...
              <el-button type="primary" @click="handleCallContract"
                >WS: Test call smart contract
              </el-button>
            </el-card>
            ...
            <el-card class="box-card">
              ...
              <el-button type="primary" @click="callOauthMethod"
                >Call
              </el-button>
            </el-card>
            ...
            <el-card class="box-card">
              ...
              <el-button type="primary" @click="oauthEthCall">Call </el-button>
            </el-card>
          </el-col>
          <el-col :span="6">
            <el-card class="box-card">
              ...
              ></el-input>
              <el-button type="primary" @click="handleCallContractByHttp"
                >HTTP: Test call smart contract
              </el-button>
              <el-button type="primary" @click="handleCallestimateGas"
                >HTTP: Test call estimateGas
              </el-button>
            </el-card>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-card class="box-card">
              ...
              <el-button type="primary" @click="getLogs"
                >HTTP: getLogs</el-button
              >

              <el-button type="primary" @click="getLogsByTxHash"
                >HTTP: getLogsByTxHash</el-button
              >
            </el-card>
          </el-col>
        </el-row>
...
import {
  ...
  HttpClient,
  Oauth2Client,
} from "@metis.io/middleware-client";
...
export default {
  ...
  methods: {
    logout() {
      ...
      this.oauth2Client
        .logout(this.appid, this.accessToken, this.refreshToken)
        .then((res) => {
    ...
    handleCallContract() {
      ...
      this.websocket.sendTx("ystoken", 1337, "transfer", [
        "0x1A13daA398B3030B8d0cE5d44d4E8C2bbe4585a3",
        1000,
      ]);
    ...
    async handleCallContractByHttp() {
      ...
      if (this.contract.args.length > 0) args = this.contract.args.split(",");
    ...
    getBalance() {
      let dom = this;
      this.httpclient.getBalance(this.chainid, this.balanceAddress).then(
        (res) => {
          this.balance = res;
    ...
    async testDAC() {
      const addresss = [
        ...
        "0xA35f56ebF874Df1B6aC09E72528e1a86D4F1EF2B",
      ];
    ...
    addToken() {
      this.httpclient
        .addTokenToMM(
          ...
          18,
          "https://polis.metis.io/static/img/polis-trans.9c0be85f.png",
          4
        )
        .then((res) => {
